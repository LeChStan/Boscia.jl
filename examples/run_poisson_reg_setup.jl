...
################# Run example #######################
try 
    poisson_reg_boscia(mode, dimension, seed, alternative, decision_function, iterations_until_stable, μ,  time_limit)
catch e 
    println(e)
    file = "poisson_reg_" * str(seed) * "_" * str(dimension) * "_" * mode 
