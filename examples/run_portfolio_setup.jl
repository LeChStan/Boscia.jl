...
################# Run example #######################
try 
    poisson_reg_boscia(mode, dimension, seed, alternative, decision_function, iterations_until_stable, μ, set, time_limit)
catch e 
    println(e)
    file = "portfolio_" * set * "_" * str(seed) * "_" * str(dimension) * "_" * mode 
